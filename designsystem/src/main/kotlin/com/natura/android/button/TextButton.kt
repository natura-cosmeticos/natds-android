...
class TextButton : MaterialButton {
    ...
    private fun setComponentStyleBySize() {
        return when (sizeAttribute) {
            SEMI_SIZE -> getStyleAttributes(R.attr.textButtonSmall)
            SEMIX_SIZE -> getStyleAttributes(R.attr.textButtonMedium)
            MEDIUM_SIZE -> getStyleAttributes(R.attr.textButtonLarge)
            else -> getStyleAttributes(R.attr.textButtonMedium)
        }
    }
