...
class IconActivity : AppCompatActivity() {
    ...
    private fun recoverListIcons() = listOf(
        ...
        R.string.icon_outlined_action_add,
        R.string.icon_outlined_action_attachment,
        R.string.icon_outlined_action_autofilter,
        R.string.icon_outlined_action_calendar,
        R.string.icon_outlined_action_cancel,
        R.string.icon_outlined_action_change,
        R.string.icon_outlined_action_check,
        R.string.icon_outlined_action_closedbox,
        R.string.icon_outlined_action_copy,
        R.string.icon_outlined_action_cycle,
        R.string.icon_outlined_action_delete,
        R.string.icon_outlined_action_done,
        R.string.icon_outlined_action_download,
        R.string.icon_outlined_action_edit,
        R.string.icon_outlined_action_favorite,
        R.string.icon_outlined_action_filter,
        R.string.icon_outlined_action_gridsquare,
        R.string.icon_outlined_action_help,
        R.string.icon_outlined_action_history,
        R.string.icon_outlined_action_like,
        R.string.icon_outlined_action_list,
        R.string.icon_outlined_action_love,
        R.string.icon_outlined_action_mic,
        R.string.icon_outlined_action_micrec,
        R.string.icon_outlined_action_newrequest,
        R.string.icon_outlined_action_order,
        R.string.icon_outlined_action_phone,
        R.string.icon_outlined_action_print,
        R.string.icon_outlined_action_rating,
        R.string.icon_outlined_action_request,
        R.string.icon_outlined_action_save,
        R.string.icon_outlined_action_schedule,
        R.string.icon_outlined_action_search,
        R.string.icon_outlined_action_selectedalllines,
        R.string.icon_outlined_action_send,
        R.string.icon_outlined_action_settings,
        R.string.icon_outlined_action_share,
        R.string.icon_outlined_action_subtract,
        R.string.icon_outlined_action_update,
        R.string.icon_outlined_action_upload,
        R.string.icon_outlined_action_visibility,
        R.string.icon_outlined_action_visibilityoff,
        R.string.icon_outlined_alert_empty,
        R.string.icon_outlined_alert_indeterminate,
        R.string.icon_outlined_alert_info,
        R.string.icon_outlined_communication_chat,
        R.string.icon_outlined_communication_email,
        R.string.icon_outlined_communication_help,
        R.string.icon_outlined_communication_message,
        R.string.icon_outlined_communication_occurrence,
        R.string.icon_outlined_communication_readEmail,
        R.string.icon_outlined_communication_signal,
        R.string.icon_outlined_communication_speaker,
        R.string.icon_outlined_communication_treatment,
        ...
        R.string.icon_outlined_product_promotionproduct,
